...
public class MainActivity extends Activity {
    ...
    private void applyPalette() {
        if (darkMode) {
            greenDark = Color.rgb(23, 112, 48);
            green = Color.rgb(39, 159, 75);
            greenSoft = Color.rgb(31, 67, 43);
            background = Color.rgb(13, 18, 15);
            cardSurface = Color.rgb(23, 29, 25);
            textMain = Color.rgb(237, 245, 239);
            textMuted = Color.rgb(168, 181, 172);
            border = Color.rgb(45, 61, 49);
            headerStart = Color.rgb(4, 50, 16);
            headerEnd = Color.rgb(10, 94, 35);
            roomChipBg = Color.rgb(29, 55, 37);
            roomChipStroke = Color.rgb(59, 121, 74);
            buildingChipBg = Color.rgb(13, 72, 30);
            buildingChipStroke = Color.rgb(46, 141, 67);
            buildingChipText = Color.rgb(235, 255, 239);
        } else {
            ...
            roomChipBg = Color.rgb(246, 252, 248);
            roomChipStroke = Color.rgb(189, 226, 197);
            buildingChipBg = Color.rgb(229, 244, 234);
            buildingChipStroke = Color.rgb(177, 220, 188);
            buildingChipText = greenDark;
        }
    }
    ...
    private void addLocationBlock(LinearLayout parent, String line) {
        ...
        if (!room.isEmpty()) {
            addLocationChip(box, "Аудитория", room, roomChipBg, roomChipStroke, greenDark, textMain);
        }
        if (!building.isEmpty()) {
            addLocationChip(box, "Корпус", formatBuildingValue(building), buildingChipBg, buildingChipStroke, buildingChipText, buildingChipText);
        }
    }

    private void addLocationChip(LinearLayout parent, String label, String value, int bgColor, int strokeColor, int labelColor, int valueColor) {
        LinearLayout chip = new LinearLayout(this);
        chip.setOrientation(LinearLayout.HORIZONTAL);
        chip.setGravity(Gravity.CENTER_VERTICAL);
        chip.setPadding(dp(12), dp(8), dp(12), dp(8));
        chip.setBackground(buttonBackground(bgColor, strokeColor));
        ...
        labelView.setPadding(dp(8), dp(4), dp(8), dp(4));
        labelView.setBackground(pillBackground(darkMode ? Color.argb(55, 255, 255, 255) : Color.argb(45, 0, 86, 24), Color.argb(0, 0, 0, 0)));
        chip.addView(labelView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
        ...
        chip.addView(valueView, valueParams);
