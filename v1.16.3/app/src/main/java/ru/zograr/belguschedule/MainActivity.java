...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.16.3");
    ...
    private void downloadUpdateApk(String apkUrl, String tagName) {
        ...
        try {
            ...
            startUpdateProgressPolling(updateDownloadId, tagName);
        } catch (Exception e) {
            new AlertDialog.Builder(this)
        ...
        try {
            ...
            try {
                ...
                if (status == DownloadManager.STATUS_RUNNING || status == DownloadManager.STATUS_PENDING || status == DownloadManager.STATUS_PAUSED) {
                    ...
                    downloadedUpdateUri = null;
                    showUpdateDownloadProgressDialog(tagName);
                    startUpdateProgressPolling(savedId, tagName);
                    return true;
                }
    ...
    private void openApkInstaller(Uri apkUri) {
        try {
            ...
            showDownloadOpenError("Не удалось открыть установщик. Нажми на скачанный APK в уведомлении загрузки или попробуй ещё раз.");
        }
    }
