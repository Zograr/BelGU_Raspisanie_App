...
public class MainActivity extends Activity {
    ...
    private void addGradesTools() {
        ...
        TextView sub = new TextView(this);
        sub.setText("Для обычного просмотра выбери семестр и неделю. Для отдельного списка двоек и Н/НН нажми «Собрать все 2 / Н / НН» — приложение пройдёт по неделям и покажет предмет, дату и оценку.");
        sub.setTextColor(textMuted);
        sub.setTextSize(13);
...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.17.12.122.111.100.9.8.7.6.5.5.4.3.2");
