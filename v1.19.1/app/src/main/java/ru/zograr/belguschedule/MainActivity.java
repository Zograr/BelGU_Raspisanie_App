...
public class MainActivity extends Activity {
    ...
    private boolean suppressCardAnimations = false;
    ...
    private void refreshSettingsPanelContentNoAnimation() {
        boolean old = suppressCardAnimations;
        suppressCardAnimations = true;

        try {
            refreshSettingsPanelContent();
        } finally {
            suppressCardAnimations = old;
        }
    }
    ...
    private void addModeSwitch() {
        ...
        View.OnClickListener listener = v -> {
            ...
            refreshSettingsPanelContentNoAnimation();
        };
    ...
    private void showAutoUpdateTimeDialog() {
        ...
        TimePickerDialog dialog = new TimePickerDialog(this, (view, selectedHour, selectedMinute) -> {
            ...
            if (settingsOpen) refreshSettingsPanelContentNoAnimation();
        }, hour, minute, true);
    ...
    private void addThemeOptionCard(String mode, String titleText, String subtitleText) {
        ...
        if (appFrame != null) {
            appFrame.animate().cancel();
            appFrame.animate()
                    .alpha(0.88f)
                    .setDuration(90)
                    .withEndAction(() -> applyThemeModeNow(mode))
                    .start();
        } else {
            applyThemeModeNow(mode);
        }
    }

    private void applyThemeModeNow(String mode) {
        themeMode = mode;
        darkMode = themeMode.endsWith("_dark");
...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.19.1");
