...
public class MainActivity extends Activity {
    ...
    private void settingsQuickButton(LinearLayout row, String title, String subtitle, View.OnClickListener listener, boolean left) {
        ...
        LinearLayout.LayoutParams subParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        subParams.setMargins(0, dp(2), 0, 0);
    ...
    private void addGradesTools() {
        ...
        TextView sub = new TextView(this);
        sub.setText("Выбери семестр, затем неделю. После выбора недели оценки загрузятся автоматически. Кнопка «Подгрузить семестр» соберёт все недели выбранного семестра.");
        sub.setTextColor(textMuted);
        sub.setTextSize(13);
        ...
        TextView collect = gradesBigButton("Собрать выбранную неделю");
        ...
        actionsCard.addView(collect, collectParams);
        ...
        TextView loadSemester = gradesSmallButton("Подгрузить семестр");
        loadSemester.setOnClickListener(v -> loadGradesForSelectedSemester());
        row2.addView(loadSemester, new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1));

        TextView problems = gradesSmallButton("Показать 2 / Н / НН");
        problems.setOnClickListener(v -> showProblemsFromLastGrades());
        LinearLayout.LayoutParams problemsParams = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1);
        problemsParams.setMargins(dp(8), 0, 0, 0);
        row2.addView(problems, problemsParams);
        ...
        row3.addView(reset, new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1));
        ...
        row3.addView(relogin, reloginParams);
    ...
    private void loadGradesForSelectedSemester() {
        ...
        addGradesMessage("Подгружаю семестр", "Собираю список недель выбранного семестра...");
...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.18.6.6.5.4.3.2.5.4.3.2");
