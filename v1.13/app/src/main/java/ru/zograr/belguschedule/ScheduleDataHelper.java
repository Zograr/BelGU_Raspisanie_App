...
class ScheduleDataHelper {
    ...
    static WidgetPair nearestPair(Context context) {
        ...
        if (cached.trim().isEmpty()) {
            return new WidgetPair("Нет данных", "Открой приложение", "Расписание ещё не загружено", "Группа " + group, "автообновление 7:00");
        }
    ...
    static String updatedText(String updated) {
        return updated == null || updated.trim().isEmpty() ? "автообновление 7:00" : "обновлено " + updated;
    }
