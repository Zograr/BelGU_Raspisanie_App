...
public class MainActivity extends Activity {
    ...
    private List<TeacherItem> fetchTeacherList() throws Exception {
        ...
        if (result.isEmpty()) {
            throw new Exception("Сайт не отдал список преподавателей, а в кэше приложения ещё нет расписания группы. Открой расписание группы и обнови его, потом попробуй снова.");
        }
        return result;
    }
