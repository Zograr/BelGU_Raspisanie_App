...
public class MainActivity extends Activity {
    ...
    private void showGroupDialog() {
        ...
        input.setHint("Например: 90002595");
        input.setPadding(dp(8), dp(8), dp(8), dp(8));

        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle("Выбор группы")
                .setMessage("Введи номер своей группы. Например: 90002595")
                .setView(input)
    ...
    private void applyPalette() {
        if (darkMode) {
            ...
            roomChipBg = Color.rgb(26, 38, 56);
            roomChipStroke = Color.rgb(91, 135, 184);
            buildingChipBg = Color.rgb(58, 40, 22);
            buildingChipStroke = Color.rgb(224, 149, 58);
            buildingChipText = Color.rgb(255, 221, 166);
        } else {
            ...
            roomChipBg = Color.rgb(241, 248, 255);
            roomChipStroke = Color.rgb(176, 210, 238);
            buildingChipBg = Color.rgb(255, 247, 235);
            buildingChipStroke = Color.rgb(232, 196, 142);
            buildingChipText = Color.rgb(116, 72, 18);
        }
    }
    ...
    private void addLocationBlock(LinearLayout parent, String line) {
        ...
        if (!room.isEmpty()) {
            addLocationCard(box, "Аудитория", room, roomChipBg, roomChipStroke,
                    darkMode ? Color.rgb(157, 209, 255) : Color.rgb(31, 91, 145),
                    darkMode ? Color.rgb(232, 244, 255) : Color.rgb(18, 48, 78));
        }
        if (!building.isEmpty()) {
            addLocationCard(box, "Корпус", formatBuildingValue(building), buildingChipBg, buildingChipStroke,
                    buildingChipText,
                    darkMode ? Color.rgb(255, 241, 216) : Color.rgb(91, 55, 12));
        }
    }
