...
public class MainActivity extends Activity {
    ...
    private void applyPalette() {
        if (darkMode) {
            ...
            roomChipBg = Color.rgb(18, 42, 27);
            roomChipStroke = Color.rgb(70, 151, 91);
            buildingChipBg = Color.rgb(13, 57, 29);
            buildingChipStroke = Color.rgb(86, 182, 111);
            buildingChipText = Color.rgb(214, 255, 224);
        } else {
            ...
            roomChipBg = Color.rgb(240, 250, 242);
            roomChipStroke = Color.rgb(181, 223, 190);
            buildingChipBg = Color.rgb(230, 246, 234);
            buildingChipStroke = Color.rgb(142, 198, 157);
            buildingChipText = Color.rgb(22, 91, 40);
        }
    }
    ...
    private void addLocationBlock(LinearLayout parent, String line) {
        ...
        if (!room.isEmpty()) {
            addLocationCard(box, "Аудитория", room, roomChipBg, roomChipStroke,
                    darkMode ? Color.rgb(151, 239, 171) : Color.rgb(31, 121, 50),
                    darkMode ? Color.rgb(238, 255, 242) : Color.rgb(15, 69, 28));
        }
        if (!building.isEmpty()) {
            addLocationCard(box, "Корпус", formatBuildingValue(building), buildingChipBg, buildingChipStroke,
                    darkMode ? Color.rgb(181, 255, 198) : Color.rgb(22, 91, 40),
                    buildingChipText);
        }
    }
