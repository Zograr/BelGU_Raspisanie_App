    private void LcqwxHpG3df1XcDM5HZeVXP4jPqDEs34mr() {
        ();
    }
...
public class MainActivity extends Activity {
    ...
    private void LPdbBJrXFUXMna1ydJecwWd7AsQQDknXMy(int attempt) {
        gradesWebView.evaluateJavascript(buildGetWeekOptionsScript(), value -> {
            try {
                ...
                if (weeks.length() == 0 && attempt < 5) {
                    main.postDelayed(() -> LPdbBJrXFUXMna1ydJecwWd7AsQQDknXMy(attempt + 1), 1200);
                    return;
                }
