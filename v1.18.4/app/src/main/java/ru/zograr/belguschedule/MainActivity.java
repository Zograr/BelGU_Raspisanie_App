...
public class MainActivity extends Activity {
    ...
    private void addSettingsQuickActions() {
        ...
        hint.setText("Главные разделы теперь только здесь — без дублей ниже");
    ...
    private void settingsQuickButton(LinearLayout row, String title, String subtitle, View.OnClickListener listener, boolean left) {
        ...
        titleView.setTextColor(left ? Color.WHITE : greenDark);
        ...
        subView.setTextColor(left ? Color.argb(220, 255, 255, 255) : textMuted);
    ...
    private void addGradesTools() {
        ...
        TextView sub = new TextView(this);
        sub.setText("Журнал загружается скрыто. Если нажать слишком рано — приложение попросит подождать, а не покажет выбор языка сайта.");
        sub.setTextColor(textMuted);
        sub.setTextSize(13);
        ...
        actionsHint.setText("Выбери семестр и неделю. «Сбросить выбор» очистит семестр, неделю и старый список оценок.");
...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.18.4.4.3.2.5.4.3.2");
