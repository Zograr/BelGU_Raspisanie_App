...
public class DailyUpdateReceiver extends BroadcastReceiver {
    ...
    static void scheduleDailyUpdate(Context context) {
        try {
            ...
            int hour = ScheduleDataHelper.prefs(context).getInt(ScheduleDataHelper.KEY_AUTO_UPDATE_HOUR, 7);
            int minute = ScheduleDataHelper.prefs(context).getInt(ScheduleDataHelper.KEY_AUTO_UPDATE_MINUTE, 0);
