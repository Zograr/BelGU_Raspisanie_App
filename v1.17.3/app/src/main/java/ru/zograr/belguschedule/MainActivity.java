    ...
    private void ensureGradesWebView() {
        ...
        gradesWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url != null && url.contains("journal_spo")) {
                    gradesLoggedIn = true;
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                if (request != null && request.isForMainFrame()) {
                    ...
                    if (description.toLowerCase(ru).contains("cleartext")) {
                        addGradesMessage("Ошибка HTTP", "Сайт dekanat.bsuedu.ru перекинул WebView на обычный HTTP. В v1.17.2 это разрешено через network security config. Перезапусти раздел и попробуй снова.");
                    } else {
                        addGradesMessage("Ошибка сайта", "Не удалось загрузить страницу dekanat.bsuedu.ru.\n" + description);
                    }
                }
            }
        });
...
private void addBodyLine(LinearLayout parent, String text, boolean important, int color) {
    ...
    private UpdateInfo fetchLatestRelease(String owner, String repo) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "BelGUScheduleApp/1.17.3.3.2");
    ...
    private void openApkInstaller(Uri apkUri) {
        try {
            ...
            Intent chooser = Intent.createChooser(intent, "Установить обновление");
            ...
            try {
                ...
                showDownloadOpenError("Не удалось открыть установщик APK. Разреши установку неизвестных приложений для этого приложения или установи APK вручную из GitHub Release.");
            }
        }
    }
